    ...
    start() {
      return __async(this, null, function* () {
        ...
        if (typeof confirmationMessage === "string") {
          const answer = yield FormSubmission.confirmMethod(confirmationMessage, this.formElement, this.submitter);
          if (!answer) {
            return;
          }
        }
      ...
      return __async(this, null, function* () {
        ...
        try {
          ...
          if (html) {
            ...
            const newFrameElement = yield this.extractForeignFrameElement(body);
            if (newFrameElement) {
...
//# sourceMappingURL=/_bridgetown/static/index.M5DM47VG.js.map
